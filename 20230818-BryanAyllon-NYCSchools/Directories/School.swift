...
import Foundation
/// Represents a school information model.
struct School: Codable {
    // Properties representing various school information.
    let dbn: String?
    ...
    var satScores: SATScores? //sets the SAT Scores object
    
}

/// Represents SAT scores for a school.
